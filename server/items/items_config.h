...
constexpr GunConfig GlockConfig = {.bullets_per_mag = 20,
                                   .init_mag_ammo = GlockConfig.bullets_per_mag,
                                   .init_reserve_ammo = GlockConfig.bullets_per_mag,
                                   .attack_rate = 6.6,
...
constexpr GunConfig Ak47Config = {.bullets_per_mag = 30,
                                  .init_mag_ammo = Ak47Config.bullets_per_mag,
                                  .init_reserve_ammo = Ak47Config.bullets_per_mag,
                                  .attack_rate = 10,
                                  .dir_variation_angle = 0,
...
constexpr GunConfig M3Config = {.bullets_per_mag = 8,
                                .init_mag_ammo = M3Config.bullets_per_mag,
                                .init_reserve_ammo = M3Config.bullets_per_mag,
                                .attack_rate = 1.1,
                                .dir_variation_angle = 30.0f,
                                .bullets_per_attack = M3Config.bullets_per_mag,
                                .burst_interval = 0,
                                .min_damage = 8,
                                .max_damage = 12,
...
constexpr GunConfig AwpConfig = {.bullets_per_mag = 10,
                                 .init_mag_ammo = AwpConfig.bullets_per_mag,
                                 .init_reserve_ammo = AwpConfig.bullets_per_mag,
                                 .attack_rate = 0.68,
                                 .dir_variation_angle = 0,
                                 .bullets_per_attack = 1,
                                 .burst_interval = 0,
