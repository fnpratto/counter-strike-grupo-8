...
constexpr GunConfig GlockConfig = {.bullets_per_mag = 20,
                                   .init_mag_ammo = 20,
                                   .init_reserve_ammo = GlockConfig.init_mag_ammo,
                                   .attack_rate = 6.6,
...
constexpr GunConfig Ak47Config = {.bullets_per_mag = 30,
                                  .init_mag_ammo = 30,
                                  .init_reserve_ammo = Ak47Config.init_mag_ammo,
                                  .attack_rate = 10,
                                  .dir_variation_angle = 0,
...
constexpr GunConfig M3Config = {.bullets_per_mag = 1,
                                .init_mag_ammo = 8,
                                .init_reserve_ammo = M3Config.init_mag_ammo,
                                .attack_rate = 1.1,
...
constexpr GunConfig AwpConfig = {.bullets_per_mag = 10,
                                 .init_mag_ammo = 10,
                                 .init_reserve_ammo = AwpConfig.init_mag_ammo,
                                 .attack_rate = 0.68,
                                 .dir_variation_angle = 0,
                                 .bullets_per_attack = 1,
                                 .burst_interval = 0,
